...
getDefault "XDG_STATE_HOME"  = userRelative $ "Local Settings" </> "State"
...
getDefault "XDG_STATE_HOME"  = userRelative $ ".local" </> "state"
...
-- | Get the directory for other user-specific files.
getUserStateDir     :: String -> IO FilePath
getUserStateDir     = singleDir "XDG_STATE_HOME"
...
-- | Get the path to a specific user file of another kind.
getUserStateFile         :: String -> String -> IO FilePath
getUserStateFile a f     = fmap (</> f) $ getUserStateDir a
